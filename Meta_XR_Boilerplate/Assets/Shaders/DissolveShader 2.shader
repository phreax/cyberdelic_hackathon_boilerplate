Shader "Custom/DissolveShader 2"
{
    Properties
    {
        ...
        SubShader
        {
            ...
            Pass
            {
                ...
                fixed4 frag(v2f i) : SV_Target
                {
                    ...
                    float height = 30.0; // Assuming the height of the sphere is 2 units
                    float dissolve = smoothstep(_DissolveAmount - 0.1, _DissolveAmount, (i.worldPos.y + height / 30.0) / height);
